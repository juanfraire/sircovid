...
var (
	barbijo, alchol, plasma, home1, home, monedas, relato, papiro, ciudad, tpaper, money, meds, mmeds, mhome, mhome1, bread, clothes Objetos
	objScale                                                                                                                         = .3
	barHScale                                                                                                                        float64
	barWscale                                                                                                                        float64
	coinHScale                                                                                                                       float64
...
func initObjetos() {
	...
	papiro.FrameOY = 0
	papiro.FrameNum = 1
	papiro.FrameWidth = 862
	papiro.FrameHeight = 898
	papiro.X = float64(100)
	papiro.Y = float64(-20)
